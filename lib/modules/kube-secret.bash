kube-secret::init-module() {
    ...
    declare-action kspf kube-secret-print-field "prints the value of a kubernetes secret"
    declare-action ksd  kube-secret-diff        "prints the changes to a kubernetes secret"
    declare-action ksm  kube-secret-manifest    "prints the manifest of the secret to be created"
    declare-action kspy kube-secret-print-yaml  "print the data stored in a secret as yaml"
    declare-action kssf kube-secret-save-files  "save the data stored in a secret as file(s)"
